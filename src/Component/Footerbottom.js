...
import androidstore from "../Assests/google_play.svg";
import appleStore from "../Assests/appleStore.svg";
import React from "react";

function Footerbottom() {
  return (
    <Box mt="5" bgColor="#212121" color="#ffffff" py="10">
      <Container maxW="container.xl">
        ...
        <Box
          ...
          alignItems="top"
        >
          <Box flex="1" mb={{ sm: "10", md: "0", lg: "0", xl: "0", base: "4" }}>
        ...
        >
          ...
          >
            <Image w="126px" p="3" src={androidstore} />
            <Image w="126px" p="3" src={appleStore} />
          </Box>
        </Box>
        <Box
          d="flex"
